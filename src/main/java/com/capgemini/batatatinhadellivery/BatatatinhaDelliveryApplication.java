...
public class BatatatinhaDelliveryApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Telefone tel1 = new Telefone(null, "11-34345900", "2321-6060", "94589-9090",cli1);
		cli1.setTelefone(tel1);
		//Telefone tel2= new Telefone(null, "11-24324324", "23423-6060", "967676-9090",cli1);
		//cli1.setTelefone(tel2);
